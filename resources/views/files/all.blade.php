...
@section('title', 'All Files - HR Management System')

@section('content')
<div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between">
  <div class="clearfix">
    <h1 class="app-page-title">All Files</h1>
    <span>Manage all uploaded files in the system</span>
  </div>
</div>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="fi fi-rr-folder-open me-2"></i>All Uploaded Files
            ...
            <div class="card-body">
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Files uploaded by users will appear here</p>
                    </div>
                @endif
            </div>
        </div>

...
@section('title', 'Create Permission - HR Management System')

@section('content')
<div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between">
  <div class="clearfix">
    <h1 class="app-page-title">Create New Permission</h1>
        ...
        <form action="{{ route('permissions.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @endif" 
                   ...
                   placeholder="e.g., create_employee, edit_role">
          ...
          <div class="mb-3">
            ...
            <select class="form-select @error('module') is-invalid @endif" id="module" name="module" required>
              ...
              <option value="employee" {{ old('module') === 'employee' ? 'selected' : '' }}>Employee</option>
              <option value="role" {{ old('module') === 'role' ? 'selected' : '' }}>Role</option>
              <option value="permission" {{ old('module') === 'permission' ? 'selected' : '' }}>Permission</option>
          ...
          <div class="d-flex gap-2">
            <button type="submit" class="btn btn-primary waves-effect waves-light">
              <i class="fi fi-rr-save me-1"></i> Create Permission
            </button>

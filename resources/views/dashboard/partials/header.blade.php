  ...
  <div class="app-header-inner">
    ...
    <div class="app-header-start d-none d-md-flex">
      ...
      <ul class="navbar-nav gap-4 flex-row d-none d-xxl-flex">
        <li class="nav-item">
          <a class="nav-link" href="{{ route('dashboard') }}">Reports & Analytics</a>
        </li>
        <li class="nav-item">
        ...
        <a href="#" class="d-flex align-items-center py-2" data-bs-toggle="dropdown" data-bs-auto-close="outside"
          ...
          <div class="text-end me-2 d-none d-lg-inline-block">
            ...
            <small class="text-body d-block lh-sm">
              <i class="fi fi-rr-angle-down text-3xs me-1"></i> {{ Auth::user()->role->name ?? 'User' }}
            </small>
          </div>
        ...
        <ul class="dropdown-menu dropdown-menu-end w-225px mt-1">
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('profile.edit') }}">
              <i class="fi fi-rr-edit scale-1x"></i> Edit Profile
            </a>
          </li>
          <li>
            <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('leave.my') }}">
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('password.show') }}">
              <i class="fi fi-rr-key scale-1x"></i> Change Password
            </a>
          </li>
          <li>
            <div class="dropdown-divider my-1"></div>
